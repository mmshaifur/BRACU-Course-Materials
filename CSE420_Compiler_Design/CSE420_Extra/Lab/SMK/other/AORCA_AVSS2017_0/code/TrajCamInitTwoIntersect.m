...
% Brief: This script generates the trjectories with a couple of targets interecting with varying angle with a constant velocity
...
Nt = 2; % specify the number of targets
...
if want2save
    save(['Setup/MobileCameras_TwoIntersect_' num2str(Nt) '_' num2str(ConstantVelo) '_' num2str(FixedDirection) '_' num2str(index)],'camLocM','camNumM','FOVM');
end
...
if save2figure
    imageFileName = ['RawImage/Setup/setup_TwoIntersect_' num2str(Nt) '_' num2str(ConstantVelo) '_' num2str(FixedDirection) '_' num2str(index)];
