...
% Brief: This function computes state of mobile camera state in delta T in matrix
...
function cameraStateNew = cameraStateUpdateMatrix(cameraStateNow,controlUnit,dT,dTs,L)
%%%% camera state
% x(1): x
% x(2): y
% x(3): \varphi
